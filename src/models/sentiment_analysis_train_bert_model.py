...
if __name__ == '__main__':
    ...
    reviews_label_df = pd.read_csv(args.input_file).head(200)
    ...
    model_path = f'c:\\Users\\heyun\\Capstone\\realtime_dreamer\\data\\interim\\sentiment_analysis_{model_type}_train_data_from_{train_data_provider}_Epoch{epochs}.model'
    ...
    best_model_path = f'c:\\Users\\heyun\\Capstone\\realtime_dreamer\\data\\processed\\sentiment_analysis_emotion_{model_type}_{best_epoch_F1_score_macro}.model'
    model.load_state_dict(torch.load(best_model_path, map_location=torch.device('cpu')))

    best_model_path_interim = f'c:\\Users\\heyun\\Capstone\\realtime_dreamer\\data\\interim\\sentiment_analysis_best_bert_model.model'
